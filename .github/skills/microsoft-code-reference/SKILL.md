...
description: "Use when implementing or troubleshooting Azure/.NET/Microsoft APIs: verify method/class names, parameters, packages, and working code samples from official Microsoft references."
