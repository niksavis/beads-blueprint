---
name: microsoft-docs
description: "Use when you need official Microsoft documentation (concepts, tutorials, configuration, examples) for Azure, .NET, VS Code, GitHub, Agent Framework, or Aspire using Microsoft Learn MCP first."
---
