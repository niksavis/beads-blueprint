...
- Inner code blocks from the original stay as-is.
- Do not add a new outer fence around the whole file.
...
def compress_file(filepath: Path) -> bool:
    ...
    if backup_path.exists():
        ...
        print(
            ...
            "Please remove or rename the backup file if you want to proceed."
        )
        return False
